...
def file_integrity_checker():
    ...
    if original_hash == new_hash:
        print("Integrity Status: \x1b[38;2;0;200;0mPRESERVED\x1b[0m")
    else:
        print("Integrity Status: \x1b[38;2;200;0;0mVIOLATED\x1b[0m")
...
def tampering_detection():
    ...
    if hash_before == hash_after:
        print("File Integrity: \x1b[38;2;0;200;0mPRESERVED\x1b[0m")
    else:
        print("File Integrity: \x1b[38;2;200;0;0mVIOLATED\x1b[0m (Tampering Detected!)")
